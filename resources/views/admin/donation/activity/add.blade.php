...
<div class="nk-block nk-block-lg">
    ...
    <div class="card">
        <div class="card-inner">
            <form action="{{ route('store.activity')}}" class="form-validate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-gs">
                    <input type="hidden" class="form-control" id="fv-subject" name="id_donation" value="{{ $id_donations}}" required>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label" for="fv-subject">Subject</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="fv-subject" name="subject" required autofocus>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="fv-subject" name="link" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-primary">Add Activity</button>
                        </div>
                    </div>
            </form>
        </div>
